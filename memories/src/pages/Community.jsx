            ...
            <div className='bg-[#D9D9D9] dark:bg-slate-900 h-screen'>
                ...
                <div className='bg-[#D9D9D9] dark:bg-[#1C1132] h-[92vh] w-screen overflow-y-auto flex justify-between gap-x-5 py-4 px-2 sm:px-5 md:px-16'>
                    <div className='bg-white dark:bg-[#231344] rounded-xl w-full flex items-center  py-3 md:py-6 flex-col gap-3 md:gap-4 shadow-lg'>
                        <form className='bg-[#F1F1F1] dark:bg-[#1C1132] rounded flex items-center p-2 w-[95%] sm:w-[85%] md:w-[80%] h-max border-[2px] border-[#D9D9D9] dark:border-[#33215A]'>
                        ...
                        <div className='bg-[#F1F1F1] dark:bg-[#1C1132] rounded border-[2px] border-[#D9D9D9] dark:border-[#33215A] w-[95%] sm:w-[85%] md:w-[80%] p-0.5 md:p-3 h-max'>
                            <div className=' overflow-y-auto flex flex-col gap-4 sm:gap-5 h-[73vh] md:h-[63vh] xl:h-[66vh] p-1.5 sm:p-5 lg:p-7'>
                                <Suggestion />
                                <Suggestion />
                                <Suggestion />
                                <Suggestion />
