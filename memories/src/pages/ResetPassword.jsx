                ...
                <div className='lg:w-[80%] xl:w-[70%] duration-300 my-[25%] sm:my-[16%] md:my-[10%] lg:h-auto flex flex-col dark:text-white lg:flex-row lg:my-auto justify-center p-1 sm:p-3 lg:p-5'>
                    ...
                    <div className='w-auto lg:w-[70%] bg-white dark:bg-[#231344] flex items-center justify-center py-6 px-2 lg:px-6 shadow-lg dark:shadow-black rounded-lg'>
                        <form className='flex flex-col gap-4 h-max w-full' action="">
                            ...
                            <input className="px-5 py-3 bg-transparent border-[0.5px] border-slate-400 dark:text-white dark:border-white rounded-full text-lg" type="password" placeholder="New Password.." />
                            <input className="px-5 py-3 bg-transparent border-[0.5px] border-slate-400 dark:text-white dark:border-white rounded-full text-lg" type="password" placeholder="Repeat Password.." />
                            <button className='bg-gradient-to-b from-[#9013C9] to-[#573698] text-white dark:text-white py-3 rounded-full font-semibold text-md select-none'>SET NEW PASSWORD</button>
                        </form>
                    </div>
